    ...
    <div class="card-header">
        ...
        <?php if ($_settings->userdata('type') == 1): ?>
            <div class="card-tools">
                <a href="?page=employees/manage_employee" class="btn btn-flat btn-primary">
        ...
        <div class="container-fluid">
            <table class="table table-hover table-stripped">
                ...
                <tbody>
                    ...
                    } elseif ($_settings->userdata('type') == 2 || $_settings->userdata('type') == 3 || $_settings->userdata('type') == 4 )  {
                        $loggedInDepartmentID = $_settings->userdata('department_id');
                        $qry = $conn->query("SELECT *, CONCAT(firstname, ' ', lastname) AS name FROM `users` WHERE department_id = $loggedInDepartmentID ORDER BY CONCAT(firstname, ' ', lastname) ASC");
                    }
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item" href="?page=employees/records&id=<?php echo $row['id']; ?>">
                                            <span class="fa fa-eye text-secodary"></span> View
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <?php if ($_settings->userdata('type') == 1): ?>
                                            <a class="dropdown-item" href="?page=employees/manage_employee&id=<?php echo $row['id']; ?>">
                                                <span class="fa fa-edit text-primary"></span> Edit
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item reset_password" href="javascript:void(0)"
                                                data-id="<?php echo $row['id']; ?>">
                                                <span class="fa fa-key text-primary"></span> Reset Password
                                            </a>
                                            <div class="dropdown-divider"></div>
