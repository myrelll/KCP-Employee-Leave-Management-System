				...
				<div class="row">
					...
					<div class="col-6">
						...
						<div class="form-group">
							...
							<select name="designation_id" id="designation_id" class="form-control rounded-0" data-placeholder="Please Select Designation here" reqiured>
						...
						<div class="form-group">
							...
							<input type="text" name="username" id="username" class="form-control rounded-0" value="<?php echo isset($meta['username']) ? $meta['username']: '' ?>" required>
									
						</div>
						<div class="form-group">
							<label for="password">Password</label>
							<input type="password" name="password" id="password" class="form-control" value="" autocomplete="off" data-placeholder="Leave this blank if you dont want to change the password."  <?php echo isset($meta['id']) ? "": 'required' ?>>
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select">
								...
								<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Heads</option>
								<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>President</option>
								<option value="4" <?php echo isset($meta['type']) && $meta['type'] == 4 ? 'selected' : '' ?>>Staff</option>
							</select>
				</div>
						<div class="form-group">
